		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zfioridespesa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfioridespesa-display": {
								"semanticObject": "zfioridespesa",
								"action": "display",
								"description": "Aplicação para criar reembolso de despesas",
								"title": "Reembolso de Despesa",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfioridespesa",
									"url": sap.ui.require.toUrl("zfioridespesa")
								}
							}
						}
					}
